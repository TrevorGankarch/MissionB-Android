...
/**
 * Created by Chetan on 28/2/18.
 */

public class within3adapter extends RecyclerView.Adapter<within3adapter.ViewHolder> {
    ...
    public within3adapter(ArrayList<String> namee,ArrayList<String> descc,ArrayList<String> bloodd,ArrayList<String> agee,ArrayList<String> address,ArrayList<String> phone,ArrayList<String> unit,ArrayList<String> lat,ArrayList<String> lon){
        this.namelist = namee;
        this.desclist = descc;
    ...
    @Override
    public within3adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row, parent, false);
        return new within3adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final within3adapter.ViewHolder holder, final int position) {
